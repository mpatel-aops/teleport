...
type SSHAccessPermit struct {
	...
	DisconnectExpiredCert *timestamppb.Timestamp `protobuf:"bytes,7,opt,name=disconnect_expired_cert,json=disconnectExpiredCert,proto3" json:"disconnect_expired_cert,omitempty"`
...
const file_teleport_decision_v1alpha1_ssh_access_proto_rawDesc = "" +
	...
	"\x17disconnect_expired_cert\x18\a \x01(\v2\x1a.google.protobuf.TimestampR\x15disconnectExpiredCert\x12\x1d\n" +
	"\n" +
	...
	"\x0fhost_users_info\x18\x18 \x01(\v2).teleport.decision.v1alpha1.HostUsersInfoR\rhostUsersInfo\"Y\n" +
