...
|Field|Type|Description|
|---|---|---|
|api_group|string|APIGroup specifies the API group of the resource. Can be '*' for any, but doesn't support pattern matching.|
...
|sub_resource|string|For future use.|
